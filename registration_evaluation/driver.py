...
class EvaluationDriver:
    ...
    warped_images_name_remove_str = "T2_bet_resampled_registered.nii.gz", logging_flag = False):
    ...
    def runEvaluation(self):
        utils_obj = utils.EvaluationUtils(self.evaluation_folder, self.logging_flag, self.log)
